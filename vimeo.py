...
def _is_allowed_vimeo_domain(domain_str: str, allowed_domains_exact: tuple[str, ...], allowed_domains_suffix: tuple[str, ...]) -> bool:
    """Verifica se um domínio de cookie pertence ao Vimeo ou CDNs autorizadas."""
    return domain_str in allowed_domains_exact or domain_str.endswith(allowed_domains_suffix)
...
def filter_vimeo_cookies(cookies_path_obj: Path) -> None:
    ...
    try:
        ...
        allowed_domains_exact: tuple[str, ...] = ("vimeo.com", "akamaized.net")
        allowed_domains_suffix: tuple[str, ...] = (".vimeo.com", ".akamaized.net")
        ...
        for line_str in lines_list:
            ...
            if parts_list:
                ...
                if _is_allowed_vimeo_domain(domain_str, allowed_domains_exact, allowed_domains_suffix):
                    filtered_lines_list.append(line_str)
