...
def test_filter_youtube_cookies_logic(tmp_path: Path):
    ...
    content_str: str = (
        ...
        ".malicious.com\tTRUE\t/\tFALSE\t0\tID\txyz_youtube.com_fake\n"
        "fakeyoutube.com\tTRUE\t/\tFALSE\t0\tID\tvalue5\n"
        "#HttpOnly_.other.com\tTRUE\t/\tTRUE\t0\tSESSION\tsecret123\n"
        "#HttpOnly_.youtube.com\tTRUE\t/\tTRUE\t0\tSECURE_SID\tyt_secret\n"
    )
    ...
    assert ".youtube.com\tTRUE\t/\tFALSE" in result_str
    assert ".google.com\tTRUE\t/\tFALSE" in result_str
