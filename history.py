...
# BOLT OPTIMIZATION:
# Global pre-compiled regular expressions for repeated parsing in hot loops.
    ...
    for video_dict in video_list:
        ...
        if video_id_str:
            if "pytest" not in sys.modules:
                is_youtube = _YOUTUBE_ID_PATTERN.match(video_id_str)
...
def _is_video_url_or_id(input_str: str) -> bool:
    ...
    if _YOUTUBE_ID_PATTERN.match(input_str) or _VIMEO_ID_PATTERN.match(input_str):
        return True
